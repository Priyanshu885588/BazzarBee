				...
				<div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
					...
					<div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
						...
						<div class="flex items-center border-2 py-2 px-3 rounded-2xl">
                            ...
                            <span class="text-sm ml-2 mt-4 cursor-pointer">Do not have an account? <a href="#" className="hover:text-blue-500">SignIn</a></span>
							<button type="submit" class="block w-full bg-black mt-2 py-2 rounded-2xl text-white font-semibold mb-2">Login</button>
